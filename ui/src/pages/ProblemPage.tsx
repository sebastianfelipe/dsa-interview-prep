...
export function ProblemPage() {
  ...
  return (
    <main className="page page-problem">
      <p className="muted">
      ...
      {problem.hasSolution && !revealed && (
        <p className="muted solution-hidden-hint">
          Solutions are hidden. Turn on <strong>Solutions on</strong> in the header to compare approaches.
        </p>
      )}
    </main>
  );
